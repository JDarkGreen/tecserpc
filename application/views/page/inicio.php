	...
	<div class="container">
		...
		<div class="sectionPage__access__content">
			...
			<ul class="sectionPage__access__list">
				<li><a href="#"><img src="<?= IMAGES ?>/accesos/acceso1.jpg" alt="" class="img-responsive" /></a></li>			
				<li><a href="#"><img src="<?= IMAGES ?>/accesos/acceso1.jpg" alt="" class="img-responsive" /></a></li>			
				<li><a href="#"><img src="<?= IMAGES ?>/accesos/acceso1.jpg" alt="" class="img-responsive" /></a></li>			
				<li><a href="#"><img src="<?= IMAGES ?>/accesos/acceso1.jpg" alt="" class="img-responsive" /></a></li>			
				<li><a href="#"><img src="<?= IMAGES ?>/accesos/acceso1.jpg" alt="" class="img-responsive" /></a></li>			
...
<section class="sectionPage__programas">
	<div class="container">
...
<section class="sectionPage__common">
	<div class="container">
		<!-- Titulo -->
			...
			<div class="row relative">
				<div class="col-xs-3">
					<figure class="item__promo">
						<img src="<?= IMAGES ?>/promociones/promo1.jpg" alt="" class="img-responsive" />
					</figure> <!-- /.item__promo -->
				</div> <!-- /.col-xs-3 -->
				<div class="col-xs-3">
					<figure class="item__promo">
...
<section class="sectionPage__miscelaneo">
	<div class="container">
		<div class="row">
			...
			<div class="col-xs-9">
				<section class="sectionPage__miscelaneo__our-promotions">
					...
					<article class="col-xs-6">
						<figure>
							<img src="<?= IMAGES ?>/promociones/nuestra_promo.jpg" alt="" class="img-responsive" />
						</figure>
					</article> <!-- /.col-xs-6 -->
					<article class="col-xs-6">
						<figure>
...
<!-- Sección Utilitario -->
<div class="container">
	<section class="sectionPage__utilitario">
		<!-- Titulo -->
